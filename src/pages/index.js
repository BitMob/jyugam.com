      ...
      [slug]: {
        zh: (
          <div key={slug} className={cx}>
            <div dangerouslySetInnerHTML={{ __html: zh }} />
          </div>
        ),
        en: (
          <div key={slug} className={cx}>
      ...
      <div className={`col ${key}`} key={key}>
        <div className="heading">
          ...
          {!isAbout ? (
            <a
              className="expand"
              onClick={() => setExpands({ ...expands, [key]: !expanded })}
            >
              {"("}
